...
class ModelNameAdmin(admin.ModelAdmin):
    ...
    list_display = [
        "website_visits",
        "unique_visitors",
        "average_time_visitor",
        "database_searches",
        "database_searching_users",
        "average_search_visitor",
    ]
    ...
    def get_list_display(self, request):
        ...
        self._unique_visitors, self._website_visits, self._average_time_visitor = (
            GoogleAnalytics.visitors_report(start_date=start_date, end_date=end_date)
        )
        ...
        self._database_searches = SearchDetail.objects.filter(
            **search_database_query
        ).count()
        self._database_unique_users_search_count = (
            SearchDetail.objects.filter(**search_database_query)
            .values("ipaddress")
            .annotate(Count("pk"))
            .count()
        )
...
class ModelNameAdmin(admin.ModelAdmin):
    ...
    list_filter = [
        ("range_date", CustomDateRangeFilter),
        CustomDateFilter,
        "country",
        CityFilter,
    ]
    ...
    def get_list_display(self, request):
        ...
        CitiesAnalytics.objects.bulk_create(
            [CitiesAnalytics(**obj) for obj in self._city_report]
        )
        return self.list_display
...
class ModelNameAdmin(admin.ModelAdmin):
    ...
    def get_list_display(self, request):
        ...
        PagesAnalytics.objects.bulk_create(
            [PagesAnalytics(**obj) for obj in self._page_report]
        )
        return self.list_display
...
class ModelNameAdmin(admin.ModelAdmin):
    ...
    def get_list_display(self, request):
        ...
        DeviceAnalytics.objects.bulk_create(
            [DeviceAnalytics(**obj) for obj in self._device_report]
        )
        return self.list_display
...
class ModelNameAdmin(admin.ModelAdmin):
    ...
    def get_list_display(self, request):
        ...
        ChannelAnalytics.objects.bulk_create(
            [ChannelAnalytics(**obj) for obj in self._channel_report]
        )
        return self.list_display
