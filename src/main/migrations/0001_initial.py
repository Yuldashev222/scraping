# Generated by Django 3.2.16 on 2023-03-16 07:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.CharField(help_text="word in filename", max_length=255),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("s", "kommunstyrelsen"), ("f", "kommunfullmäktige")],
                        max_length=1,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.URLField(
                        max_length=400,
                        unique=True,
                        validators=[main.validators.validate_link],
                    ),
                ),
                ...
                (
                    "is_completed",
                    models.BooleanField(default=False, verbose_name="är klart"),
                ),
            ],
            options={
                "verbose_name": "länk",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "result_files_cnt",
                    models.PositiveIntegerField(verbose_name="antal filer hittade"),
                ),
                (
                    "date_created",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        max_length=400, upload_to=main.services.file_upload_location
                    ),
                ),
                ("text", models.TextField(blank=True)),
                ("pages", models.PositiveSmallIntegerField(blank=True, null=True)),
                ("size", models.FloatField(blank=True, null=True)),
                ("source_file_link", models.URLField(blank=True, null=True)),
                ("file_date", models.DateField(blank=True, null=True)),
                (
                    "is_scanned",
                    models.BooleanField(default=False, verbose_name="skannade"),
                ),
                (
                    "inform",
                    models.ForeignKey(
